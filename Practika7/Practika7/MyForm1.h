...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Безвозвратно удалить данные из общей базы\r\n";
...
#pragma endregion
	...
	private: System::Void radioButton1_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
		A->Look(dataGridView1, 2);
		this->button1->Text = L"Безвозвратно удалить заявки из общей базы\r\n";
	}
	private: System::Void radioButton2_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
		A->Look(dataGridView1, 3);
		this->button1->Text = L"Вернуть все заявки в статус запроса";
	}
